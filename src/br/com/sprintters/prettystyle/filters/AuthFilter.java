...
public class AuthFilter implements Filter {
	...
	private boolean verifyRoute(String commandCalled) {
    	...
    	switch (commandCalled) {
    		...
    		case "productdetails.ViewProduct"		: isAuthorize = true;	break;
    		...
    		case "signup.CreateUser"				: isAuthorize = false;	break;
    		case "address.NavigateToCreateAddress"	: isAuthorize = true;	break;
    		case "admin.NavigateToAdmin"			: isAuthorize = true;	break;
    		case "admin.NavigateToNewCategory"		: isAuthorize = true;	break;
    		case "admin.NavigateToNewMark"			: isAuthorize = true;	break;
    		case "admin.NavigateToNewProduct"		: isAuthorize = true;	break;
    		case "signin.NavigateToLogin"			: isAuthorize = true;	break;
