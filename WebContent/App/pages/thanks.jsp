<div class="catalog-myproducts-thanks-container">
	<div class="container">
		...
		<div class="jumbotron main">
			<div class="col-md-12 content">
				<div id="thanks">
					<h3 class="color-blue">Obrigado por efetuar sua compra na
						PrettyStyle!</h3>
				</div>
				<div class="container" id="confirm">
					<svg xmlns="http://www.w3.org/2000/svg" id="img-right" width="100"
				...
				<div class="container" id="body-thanks">
					...
					<div class="pt-5">
						...
						<p id=bt-p>A partir de agora, você será informado(a) por
							e-mail sobre o andamento do seu pedido até a chegada no endereço
							escolhido.</p>
					</div>
					<div id="nPedido">
