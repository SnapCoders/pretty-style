									...
									<div class="product-details-area">
										<div class="row product-title">
											<div class="product-info">
												<label>JBL Flip 3 Portable</label> <span
													class="product-description">Uma caixa de som com 30
													watts de potência.</span>
												<div class="stars">
											...
											<div class="like-product">
												<div class="favorite">
													<div class="favorite-icon">
														<input type="image"
														src="../../assets/icons/heart.svg" id="like">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row product-info-more">
											<span>Mais informações</span> <span>Este produto é
												vendido e entregue por <a href="#"
												style="color: #0E9AEF; font-weight: bold;">Pretty Style</a>
											</span>
										</div>
